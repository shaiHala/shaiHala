# Hi, I'm Hala Chaimae Oukhira 👋
### Full-Stack Developer | Spring Boot · Laravel · React · Kotlin/Swift · API Design
...
I'm a passionate and results-driven Full-Stack Developer with over 3 years of experience in developing scalable web and mobile applications. I specialize in backend development with **Spring Boot (Java)** and **Laravel (PHP)**, and create dynamic frontends using **ReactJS**, **AngularJS**, and **Ionic**.

I'm also experienced in building **native mobile plugins** using **Capacitor, Kotlin, and Swift**, and I've contributed to workflow automation projects with **SharePoint**.

---

## 🛠️ Tech Stack

- **Languages:** Java, PHP, Kotlin, Swift, JavaScript, TypeScript  
- **Frontend:** React, AngularJS, HTML5, CSS3, Ionic  
- **Backend:** Spring Boot, Laravel, Node.js  
- **Mobile:** Capacitor, Native Plugins (Kotlin/Swift)  
- **Databases:** MySQL, PostgreSQL, Oracle  
- **Tools:** Git, SharePoint, Jira, VS Code, IntelliJ, Xcode  
- **Others:** API Design, Testing, SEO Optimization, Agile Methodologies
...
- 🎓 MSc in Software Quality – Faculty of Sciences, Tétouan  
- 🎓 Bachelor in Software Engineering – Fez  
- 🎓 Diploma in Computer Engineering – Meknes

---

## 🌱 Currently Learning

- Advanced **MediaPipe** integrations  
- Cloud deployments with **AWS** & **Vercel**  
- Cross-platform plugin architecture with **Capacitor 6**
...
<a href="https://laravel.com/" target="_blank" rel="noreferrer"><picture>
<img height="36" width="36" src="https://raw.githubusercontent.com/ShahVandit8/profile-x/refs/heads/main/public/icons/skills/laravel-colored.svg" alt="Laravel" />
</picture></a> &nbsp;
...
<a href="https://www.github.com/shaiHala" target="_blank" rel="noreferrer">
<picture>
...
<a href="https://www.linkedin.com/in/hala-chaimae-oukhira-3b9881101/" target="_blank" rel="noreferrer">
<picture>
